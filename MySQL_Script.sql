...
CREATE TABLE POST_POST (
  ...
  POST_ASSUNTO VARCHAR(100) NOT NULL,
  POST_TEXTO VARCHAR(500) NOT NULL,
  USR_CRIACAO_ID BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (POST_ID),
  FOREIGN KEY POST_USR_FK (USR_CRIACAO_ID) REFERENCES USR_USUARIO(USR_ID) ON DELETE RESTRICT ON UPDATE CASCADE
);
